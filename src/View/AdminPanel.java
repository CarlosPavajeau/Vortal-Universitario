...
public class AdminPanel extends Panel
{
    ...
    protected void InitPanel() 
    {
        AddCenterComponentY(new Button(TypeButton.BUTTON_ICON_DATA_MANAGER, 
                            (ActionEvent evt) -> { MainWindow.ChangePanel(this, Panels.DATA_HANDLER_PANEL); }),
                            60);
        AddCenterComponentY(new Button(TypeButton.BUTTON_ICON_STUDENT_HANDLER, 
                            (ActionEvent evt) -> { MainWindow.ChangePanel(this, Panels.STUDENT_HANDLER_PANEL); }), 
                            185);
        AddCenterComponentY(new Button(TypeButton.BUTTON_ICON_SUBJECT_HANDLER, 
                            (ActionEvent evt) -> { MainWindow.ChangePanel(this, Panels.SUBJECT_HANDLER_PANEL); }), 
                            310);
        AddCenterComponentY(new Button(TypeButton.BUTTON_ICON_ACADEMIC_SEMESTER_HANDLER, 
                            (ActionEvent evt) -> { MainWindow.ChangePanel(this, Panels.ACADEMIC_SEMESTER_HANDLER_PANEL); }), 
                            435);
        AddCenterComponentY(new Button(TypeButton.BUTTON_ICON_PENSUM_HANDLER, 
                            (ActionEvent evt) -> { MainWindow.ChangePanel(this, Panels.PENSUM_HANDLER_PANEL); }), 
                            560);
        AddCenterComponentY(new Button(TypeButton.BUTTON_ICON_STUDENT_GROUP_HANDLER, 
                            (ActionEvent evt) -> { MainWindow.ChangePanel(this, Panels.STUDENT_GROUP_HANDLER_PANEL); }), 
                            685);
        AddCenterComponentY(new Button(TypeButton.BUTTON_ICON_PROFESSOR_HANDLER, 
                            (ActionEvent evt) -> { MainWindow.ChangePanel(this, Panels.PROFESSOR_HANDLER_PANEL); }), 
                            810);
